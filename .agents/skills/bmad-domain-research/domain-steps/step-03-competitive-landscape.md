...
**{{research_topic}}** to understand the competitive ecosystem.
...
Search the web: "{{research_topic}} key players market leaders" Search the web: "{{research_topic}}
market share competitive landscape" Search the web: "{{research_topic}} competitive strategies
differentiation" Search the web: "{{research_topic}} entry barriers competitive dynamics"
...
[Different customer bases by competitor]_ _Source: [URL]_
...
different players innovate]_ _Source: [URL]_
...
customer loyalty]_ _Source: [URL]_
...
customers to switch between providers]_ _Source: [URL]_
...
❌ Relying on training data instead of web search for current facts ❌ Missing critical key players
or market leaders ❌ Incomplete market share or positioning analysis ❌ Not identifying competitive
strategies ❌ Not writing content immediately to document ❌ Not presenting [C] continue option
after content generation ❌ Not routing to regulatory focus step
