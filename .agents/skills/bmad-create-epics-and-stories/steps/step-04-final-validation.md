...
- **File Churn Check:** Do multiple epics repeatedly modify the same core files?
  ...
  - If overlap is significant: Validate that splitting provides genuine value (risk mitigation,
    feedback loops, context size limits)
  ...
  - ✅ RIGHT: Epics target distinct files/components, OR consolidation was explicitly considered and
