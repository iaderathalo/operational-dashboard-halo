...
<critical>This checklist is executed as part of: ./workflow.md</critical> <critical>Work through
each section systematically with the user, recording findings and impacts</critical>
