...
export default class DatadogSyncService {
    ...
    async syncAll(): Promise<SyncSummary> {
        ...
        this.logger.info('Datadog sync complete', summary);
        return summary;
    }
    ...
    private async syncOne(app: Application, snapshot: DatadogSnapshot): Promise<void> {
        const { monitors, slo, resolutionPath } = this.resolve(app, snapshot);
     ...
     */
    private resolve(app: Application, snapshot: DatadogSnapshot): Resolution {
